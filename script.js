...
const adultChallenges = [
    "Give a 1-minute massage", "Whisper something naughty", "Give a passionate kiss", 
    "Take off one item of clothing", "Cuddle for 2 minutes", "Nibble on an earlobe",
    "Blindfolded touch challenge", "Slow dance with no music", "Feed your partner a snack",
    "Send a spicy text to each other", "Re-enact your first kiss", 
    "Describe your favorite fantasy", "5 minutes in heaven", "Trace a finger on their back"
];
